...
export const metadata: Metadata = {
  ...
  description: `Risposte alle domande più frequenti su parodontologia, ortodonzia, impianti dentali e trattamenti dentali a Lecce. Scopri tutto sui nostri servizi presso lo studio ${config.studio.dottore}.`,
  keywords: [
    'domande frequenti dentista lecce',
    'faq studio dentistico lecce',
