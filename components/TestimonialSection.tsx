...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    text: 'Dopo anni di insicurezza, finalmente posso sorridere senza vergogna. I dottori Di Tanna e Cairo sono stati professionali e delicati, non ho sentito alcun dolore.',
